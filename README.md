...
![Image text](https://raw.githubusercontent.com/cokkeijigen/doko_iku_cn/master/Pictures/test.png)<br>

## 0x01 如何解包
**游戏目录下的`.pak`就是资源封包文件，其实这个封包的结构很简单，用`winhex`打开看个大概就能猜出结构<br>如下图：**
![Image text](https://raw.githubusercontent.com/cokkeijigen/doko_iku_cn/master/Pictures/file_head.png)<br>
...
![Image text](https://raw.githubusercontent.com/cokkeijigen/doko_iku_cn/master/Pictures/file_data.png)<br>
...
![Image text](https://raw.githubusercontent.com/cokkeijigen/doko_iku_cn/master/Pictures/file_data1.png)<br>
**然后右键`复制选块`->`至新文件`，文件名就为`-select.wav`，然后保存，最后在用音乐播放器打开，如果能正常播放那就是再次证实了。**
![Image text](https://raw.githubusercontent.com/cokkeijigen/doko_iku_cn/master/Pictures/file_data2.png)<br>
...
```
**解包：[PackManger.hpp](https://github.com/cokkeijigen/doko_iku_cn/blob/master/DOKOIKU/doko_iku_cn/src/PackManger.hpp)、[unpack_main.cpp](https://github.com/cokkeijigen/doko_iku_cn/blob/master/DOKOIKU/unpack/unpack_main.cpp)**<br>
...
![Image text](https://raw.githubusercontent.com/cokkeijigen/doko_iku_cn/master/Pictures/ida_code.png) <br>
...
```
**详细：[dllmain.cpp](https://github.com/cokkeijigen/doko_iku_cn/blob/master/DOKOIKU/doko_iku_cn/src/dllmain.cpp)、[utils.hpp](https://github.com/cokkeijigen/doko_iku_cn/blob/master/DOKOIKU/doko_iku_cn/utillibs/utils.hpp)。** <br>
### 半角字符显示效果图：
![Image text](https://raw.githubusercontent.com/cokkeijigen/doko_iku_cn/master/Pictures/test1.png)
![Image text](https://raw.githubusercontent.com/cokkeijigen/doko_iku_cn/master/Pictures/test2.png)<br>
**非常奈斯（）** ![Image text](https://raw.githubusercontent.com/cokkeijigen/doko_iku_cn/master/Pictures/w.jpg)
